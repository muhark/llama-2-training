...
def main():
    ...
    # model_name_or_path = "/scratch/gpfs/mj2976/.cache/huggingface/models--meta-llama--Llama-2-70b-chat-hf/snapshots/9ff8b00464fc439a64bb374769dec3dd627be1c2"
    model_name_or_path = "/scratch/gpfs/mj2976/.cache/huggingface/models--meta-llama--Llama-2-7b-chat-hf/snapshots/08751db2aca9bf2f7f80d2e516117a53d7450235"
    ...
    dataset = DatasetDict.load_from_disk('/scratch/gpfs/mj2976/projects/llama-2-training/data/text_only_split')
